Vue.component("purple_background_cta_component_1722344739", {
    ...
    <section class="bg-gray-900 py-20">
        <div class="max-w-6xl mx-auto px-4 sm:px-6">
            <!-- Hero section -->
            <div class="bg-gradient-to-br from-blue-900 to-black rounded-3xl shadow-2xl overflow-hidden mb-20 p-10">
                <div class="grid md:grid-cols-2 gap-10 items-center">
                    <div class="text-white">
                        <h1 class="text-6xl font-bold mb-4 text-purple-300 leading-tight">Embark on Epic<br>Cosmic Odysseys</h1>
                        <p class="text-purple-200 mb-6 text-xl">Unveil the mysteries of distant galaxies, witness breathtaking celestial phenomena, and create lasting memories across the vast expanse of space.</p>
                        <div class="flex space-x-4">
                            <a href="#" class="bg-purple-600 text-white font-semibold py-3 px-6 rounded-full hover:bg-purple-500 transition duration-300 shadow-lg flex items-center">
                                <i class='bx bx-rocket mr-2'></i>
                                Launch Your Adventure
                            </a>
                            <a href="#" class="bg-transparent border-2 border-purple-400 text-purple-300 font-semibold py-3 px-6 rounded-full hover:bg-purple-800 hover:text-white transition duration-300 shadow-lg flex items-center">
                    ...
                    <div class="flex justify-center">
                        <img src="https://placehold.co/500x400" alt="Interstellar journey illustration" class="rounded-2xl shadow-lg border-4 border-purple-600 glow">
                    </div>
                </div>
            </div>
