            ...
            <div class="flex items-center justify-between h-16 md:h-20">
                ...
                <nav id="desktop-navigation" class="hidden md:flex md:grow">
                    ...
                    <ul id="desktop-menu-links" class="flex grow justify-center flex-wrap items-center">
                        <li><a id="Explore Destinations-link" class="font-medium text-sm mx-4 lg:mx-5 transition duration-150 ease-in-out" :class="[textStylePrimary, hoverTextStylePrimary]" href="Explore Destinations.html">Explore Destinations</a></li>
                        <li><a id="Book Flights-link" class="font-medium text-sm mx-4 lg:mx-5 transition duration-150 ease-in-out" href="Book Flights.html" :class="[textStylePrimary, hoverTextStylePrimary]">Book Flights</a></li>
                        <li><a id="Find Hotels-link" class="font-medium text-sm mx-4 lg:mx-5 transition duration-150 ease-in-out" href="Find Hotels.html" :class="[textStylePrimary, hoverTextStylePrimary]">Find Hotels</a></li>
                        <li><a id="Travel Deals-link" class="font-medium text-sm mx-4 lg:mx-5 transition duration-150 ease-in-out" href="Travel Deals.html" :class="[textStylePrimary, hoverTextStylePrimary]">Travel Deals</a></li>
                        <li><a id="Travel Guide-link" class="font-medium text-sm mx-4 lg:mx-5 transition duration-150 ease-in-out" href="Travel Guide.html" :class="[textStylePrimary, hoverTextStylePrimary]">Travel Guide</a></li>
                    </ul>
                ...
                <div id="mobile-menu" class="md:hidden flex items-center ml-4" x-data="{ expanded: false }">
                    ...
                    <nav id="mobile-nav" class="absolute top-full z-20 left-0 w-full px-4 sm:px-6 overflow-hidden transition-all duration-300 ease-in-out" x-ref="mobileNav" :style="expanded ? 'max-height: ' + $refs.mobileNav.scrollHeight + 'px; opacity: 1' : 'max-height: 0; opacity: .8'" @click.outside="expanded = false" @keydown.escape.window="expanded = false" x-cloak>
                        <ul id="mobile-nav-list" class="border border-transparent rounded-lg px-4 py-1.5" :class="signUpButtonGradient">
                            <li><a id="mobile-Explore Destinations-link" class="flex font-medium text-sm py-1.5" href="Explore Destinations.html" :class="[textStylePrimary,hoverTextStylePrimary]">Explore Destinations</a></li>
                            <li><a id="mobile-Book Flights-link" class="flex font-medium text-sm py-1.5" href="Book Flights.html" :class="[textStylePrimary,hoverTextStylePrimary]">Book Flights</a></li>
                            <li><a id="mobile-Find Hotels-link" class="flex font-medium text-sm py-1.5" href="Find Hotels.html" :class="[textStylePrimary,hoverTextStylePrimary]">Find Hotels</a></li>
                            <li><a id="mobile-Travel Deals-link" class="flex font-medium text-sm py-1.5" href="Travel Deals.html" :class="[textStylePrimary,hoverTextStylePrimary]">Travel Deals</a></li>
                            <li><a id="mobile-Travel Guide-link" class="flex font-medium text-sm py-1.5" href="Travel Guide.html" :class="[textStylePrimary,hoverTextStylePrimary]">Travel Guide</a></li>
                        </ul>
                    </nav>
